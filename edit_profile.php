...
$idpro = $_GET['editpro'];
$query = "select * from profile where id_profile = $idpro";
...
<form  method="POST" action="update_profile.php">
	<input type="text" name="id" value="<?php echo $data['id_profile']?>" style="visibility:hidden">
<h2>Judul : <input class="judul" type="text" name="judul_profile" value="<?php echo $data['judul']?>"></h2></br>
<textarea class='tinymce' name='isi_profile' style="height:40px"><?php echo $data['isi']?></textarea>
</br>
