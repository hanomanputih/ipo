...
<?php
	...
	*/
	...
	/* Get data. */
	$sql = "SELECT * FROM $tbl_name order by id_berita desc LIMIT $start, $limit";
...
?>
<h2 id="judul_menu">NEWS</h2>
	<?php
		while($row = mysql_fetch_array($result))
		{ $tahun = $row['tahun']+2000;
	?>

		<?php echo "<h2>".$row['judul']."</h2><i style='color:black'>".$row['tanggal']." ".$row['bulan']." ".$tahun."</i>";?>
			<?php echo "<p>".substr($row['isi'],0,500)."</p>";
					echo "<a href=admin.php?lengkap=$row[id_berita]></br>... read more</a></br>";
