...
<body>
        <h2 id="judul_menu">UPDATE PROFILE</h2>
<form method="POST" action="input_profile.php">
<h2>Judul : <input class="judul" type="text" name="judul_profile" ></h2></br>
<h6>Isi Profile</h6>
<textarea class='tinymce' name='isi_profile' style="height:40px"></textarea>
</br>
<input class="btn" type="reset" name="reset" value="Reset" />
<input class="btn" type="submit" name="save" value="Submit" onclick="TINY.box.show({html:'The entry has successfully!',animate:false,close:false,mask:false,boxid:'success',autohide:5,top:45,left:400})"/>
